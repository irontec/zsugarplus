...
ironsugar.prototype._callREST = function (method,data,callback) {
	...
	this._doPOST(this.url, arr.join("&"), callback);
}
...
ironsugar.prototype.login = function(callback) {
	this._callREST("login",'[{"password":"'+this.pass+'","user_name":"'+this.user+'"},"'+this.application+'",[]]',
			new AjxCallback(this, this.postlogin));
	return;
};
...
ironsugar.prototype.getContactsFromMail = function(email, callback){
        ...
        this._callREST("get_entry_list",'["'+this.sessid+'","Contacts","'+q+'","",0,["id","first_name","last_name"],"[]",100,"false"]', new AjxCallback(this, this.postOp, callback));
...
ironsugar.prototype.getLeadsFromMail = function(email, callback){
        ...
        this._callREST("get_entry_list",'["'+this.sessid+'","Leads","'+q+'","",0,["id","first_name","last_name"],"[]",100,"false"]',new AjxCallback(this, this.postOp, callback));
